# Multi-Threaded "Guess the Magic Number" Game
...
### **Client Handling (`SocketThread`)**
Each client thread allows a player to:
1. **Enter their name.**
2. **Guess the magic number** (using input from the client).
3. **Receive feedback:**
...
4. When a player finds the correct number, a **broadcast message** is sent to all other players, informing them that the game has been won.
